...
function transcriptPath(dateIso: string): string {
...
async function appendSection(title: string, body: string): Promise<void> {
...
export async function logThought(note: string): Promise<void> {
...
export async function logSystemCommand(
  command: string,
  output: string,
  exitCode: number,
): Promise<void> {
